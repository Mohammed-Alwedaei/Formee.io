...
namespace Subscriptions.BusinessLogic.Migrations
{
    ...
    [Migration("20230417194327_UpdateUserSubscriptionRelationship")]
    partial class UpdateUserSubscriptionRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Subscriptions.BusinessLogic.Models.UserSubscriptionModel", b =>
                {
                    b.HasOne("Subscriptions.BusinessLogic.Models.SubscriptionsModel", "Subscriptions")
                        .WithMany()
                        .HasForeignKey("SubscriptionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
